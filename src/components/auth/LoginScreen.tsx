                  ...
                  <div className="origin-center scale-[1.10] sm:scale-[1.20] md:scale-[1.30]">
                    <TypewriterEffectSmooth
                      words={[
                        ...
                        {
                          text: "lado.",
                          className: "text-[#014a8f] dark:text-[#014a8f]",
                        },
                      ]}
                    />
                  </div>
