...
module.exports = {
  ...
  "Copa Libertadores": path.join(__dirname, "../data/matches/libertadores/2025_copal.txt"),
  "Ligue 1": path.join(__dirname, "../data/matches/ligue1/2025-26_fr1.txt"),
  "Premier League": path.join(__dirname, "../data/matches/premier-league/2025_26_premierleague.txt"),
  "Série A": path.join(__dirname, "../data/matches/serie-a-tim/2025_26_seriea.txt"),
};
